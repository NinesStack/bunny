...
type fakeRestartableConsumer struct {
	...
	restartStub        func(adapter.AMQPChannel) error
	restartMutex       sync.RWMutex
	restartArgsForCall []struct {
		arg1 adapter.AMQPChannel
	}
...
func (fake *fakeRestartableConsumer) restart(arg1 adapter.AMQPChannel) error {
...
func (fake *fakeRestartableConsumer) RestartCalls(stub func(adapter.AMQPChannel) error) {
	fake.restartMutex.Lock()
	defer fake.restartMutex.Unlock()
	fake.restartStub = stub
}

func (fake *fakeRestartableConsumer) RestartArgsForCall(i int) adapter.AMQPChannel {
	fake.restartMutex.RLock()
	defer fake.restartMutex.RUnlock()
